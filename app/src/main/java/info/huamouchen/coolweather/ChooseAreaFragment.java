...
public class ChooseAreaFragment extends Fragment {
    ...
    private void queryCounties() {
        titleText.setText(selectedCtiy.getCityName());
        backButton.setVisibility(View.VISIBLE);
        countyList = DataSupport.where("cityid = ?", String.valueOf(selectedCtiy.getId()))
                .find(County.class);
        if (countyList.size() > 0) {
            ...
            int provinceCode = selectedProvince.getProvinceCode();
            int cityCode = selectedCtiy.getCityCode();
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if ("province".equals(type)) {
                    ...
                    result = Utility.handleCountyResponse(responseText, selectedCtiy.getId());
                }
